    ...
    Informe DyF / Softys
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <DetailField label="Equipo descripciÃ³n" value={resumen.equipo_descripcion} />
          <DetailField label="Equipo ubicaciÃ³n" value={equipoUbicacionLabel || null} />
          <DetailField label="Equipo caracterÃ­sticas" value={equipoCaracteristicasLabel || null} />
          <DetailField
          ...
          <CierreStatusItem
            ...
            detail={
              hasTiempos
                ...
                : 'Opcional: puedes registrar tiempos para calcular duraciÃ³n exacta. Si no hay tiempos, se usarÃ¡ la hora actual como cierre.'
            }
          />
          ...
          <CierreStatusItem
            ...
            detail={
              hasAnyFirma
                ...
                : 'Opcional: puedes guardar firma del cliente o tÃ©cnico, pero no bloquea el cierre rÃ¡pido.'
            }
          />
