  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const empresaRow = Array.isArray(empresaJson) ? (empresaJson[0] as GenericRow | undefined) : undefined;
        ...
        const empresaLogoUrl = pickFirstString(empresaRow, [
          "logo_url",
          "logo",
          "url_logo",
          "image_url",
      ...
      <div className="space-y-4">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          ...
          <p className="mt-1 text-sm text-slate-600">
            Vuelve al dashboard, selecciona una empresa y luego entra nuevamente a cotizaciones.
          </p>
