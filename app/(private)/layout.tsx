  ...
  const syncOTPendingForTerrain = useCallback(async () => {
    ...
    for (const item of pendingItems) {
      ...
      try {
        ...
        if (payload.es_mantenimiento_general) {
          const { syncGeneralMaintenanceOffline } = await import('../../lib/offline/ot-general-maintenance')
          await syncGeneralMaintenanceOffline(payload, item.id, {
