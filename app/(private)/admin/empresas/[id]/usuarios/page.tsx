    ...
    return (
      <main className="space-y-6">
        <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm text-slate-500">Cargando usuarios de empresa...</p>
        </section>
      </main>
    )
  }
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-slate-600">
              Administra accesos por empresa. Los usuarios agregados solo podrán ver los datos
              de las empresas donde tengan un rol activo.
            </p>
      ...
      <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-5">
          ...
          <p className="text-sm text-slate-500">
            Si el email existe en perfiles, se agrega como usuario activo. Para acceso exclusivo a OT, selecciona Técnico OT / Solo OT. Si no existe, quedará como invitación pendiente.
          </p>
        </div>
